...
export default async function handler(req, res) {
  ...
  try {
    ...
    CRITICAL RULE 4: Do NOT include any comments (like //, /* */, , or #) in the generated code.
    CRITICAL RULE 5: Your output MUST be strictly valid, parsable JSON. You MUST properly escape all newlines (\\n), double quotes (\\"), and tabs (\\t) inside the JSON string values. NEVER leave raw, unescaped line breaks.`
    });
